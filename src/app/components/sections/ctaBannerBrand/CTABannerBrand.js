// components/sections/ctaBannerBrand/CTABannerBrand.js
import Button from "../../ui/Button";
import FadeUp from "../../ui/fadeUp/FadeUp";
import "./CTABannerBrand.scss";

// Full-width call to action — brand background
export default function CTABannerBrand({
	heading,
	subheading,
	cta,
	secondaryCta,
	...
	return (
		<section
			className={`block cta-banner cta-banner--brand ${classNames}`.trim()}
