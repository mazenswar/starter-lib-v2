// components/sections/ctaBannerDark/CTABannerDark.js
import Button from "../../ui/Button";
import FadeUp from "../../ui/fadeUp/FadeUp";
import "./CTABannerDark.scss";

// Full-width call to action — dark background
export default function CTABannerDark({
	heading,
	subheading,
	cta,
	secondaryCta,
	...
	return (
		<section
			className={`block cta-banner cta-banner--dark ${classNames}`.trim()}
