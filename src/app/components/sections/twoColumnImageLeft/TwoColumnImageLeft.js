// components/sections/twoColumnImageLeft/TwoColumnImageLeft.js
import Image from "next/image";
import Button from "../../ui/Button";
import FadeUp from "../../ui/fadeUp/FadeUp";
import "./TwoColumnImageLeft.scss";

// Two columns — image left, copy right
export default function TwoColumnImageLeft({
	id = "two-col",
	eyebrow,
	heading,
	subheading,
	...
	return (
		...
		>
			<div className="block__content container">
				<div className="two-col-section__layout image-first">
