// components/sections/featureGridIcon/FeatureGridIcon.js
import Button from "../../ui/Button";
import FadeUp from "../../ui/fadeUp/FadeUp";
import StaggerGrid from "../../ui/staggerGrid/StaggerGrid";
import FeatureIcon from "../../illustrations/FeatureIcon";
import "./FeatureGridIcon.scss";

// Feature grid — open four-column layout led by icons
export default function FeatureGridIcon({
	id = "feature-grid",
	heading,
	subheading,
	features,
	...
	return (
		<section
			className={`block feature-grid feature-grid--icon ${classNames}`.trim()}
